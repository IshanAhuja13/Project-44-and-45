class Game {
  ...
  handleElements() {
    ...
    this.leadeboardTitle.position(width / 3 - 350, 200);

    this.leader1.class("leadersText");
    this.leader1.position(width / 3 - 350, 240);

    this.leader2.class("leadersText");
    this.leader2.position(width / 3 - 350, 290);
  }
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      image(track, 0, -height*8, width, height * 12);
      ...
      // Finshing Line
      const finshLine = height * 6 - 100 + 1150;
